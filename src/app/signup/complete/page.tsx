  ...
  return (
    <section className="w-full max-w-md">
      <div className="text-center">
        <div className="mx-auto flex h-14 w-14 items-center justify-center rounded-full bg-rose-100 text-rose-800">
          <MailCheck className="h-7 w-7" aria-hidden />
        </div>
        <h1 className="mt-6 text-2xl font-bold text-rose-900">인증 메일을 확인해 주세요</h1>
        <p className="mt-3 text-sm leading-relaxed text-stone-600">
          아래와 같은 제목의 메일이 발송되었습니다.
          <br />
          <span className="font-medium text-stone-800">{CONFIRM_SIGNUP_EMAIL_SUBJECT}</span>
        </p>
      </div>
      ...
      <Button
        asChild
        className="mt-8 w-full rounded-2xl bg-rose-700 text-white hover:bg-rose-800"
      >
  ...
  return (
    <div className="min-h-[calc(100vh-8rem)] bg-stone-50 px-5 py-12 text-stone-800 md:px-8">
      <div className="mx-auto flex w-full max-w-6xl flex-col items-center">
        <Suspense
          fallback={
            <p className="text-sm text-stone-500">안내 화면을 불러오는 중...</p>
          }
        >
